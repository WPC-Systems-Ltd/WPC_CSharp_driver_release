...
/// 
/// This example demonstrates how to get AI data with loop in N samples mode from WifiDAQE3A.
/// 
...
{
    static void loop_func(WifiDAQE3A handle, int port, int num_of_samples, int delay = 1, int timeout = 3)
    {
        int t = 0;
        while (t < timeout)
        {
