...
/// Additionally, it utilizes a loop to retrieve AI data with 8 channels from USBDAQF1AD with a timeout of 300 ms.
///
...
{
    static void loop_func(USBDAQF1AD handle, int port, int num_of_samples=600, int delay=50, int exit_loop_time=300)
    {
        int time_cal = 0;
