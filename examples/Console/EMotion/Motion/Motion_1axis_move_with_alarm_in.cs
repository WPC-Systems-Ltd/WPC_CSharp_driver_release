    ...
    static public void Main()
    {
        ...
        try
        {
            ...
            */
            ...
            err = dev.Motion_cfgAlarm(port, axis, Const.MOT_FALSE, Const.MOT_ACTIVE_LOW, timeout);
            Console.WriteLine($"Motion_cfgAlarm in axis{axis}, status: {err}");
            ...
            Console.WriteLine($"Motion_startSingleAxisMove in port{port}, status: {err}");
