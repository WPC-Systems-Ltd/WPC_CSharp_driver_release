/// Motion_1axis_move_with_breakpoint.cs with synchronous mode.
///
...
class EMotion_1axis_move_with_breakpoint
{
    static public void Main()
    {
        ...
        try
        {
            ...
            Console.WriteLine($"Motion_cfgBreakPoint in axis{axis}, status: {err}");

            err = dev.Motion_enableBreakPoint(port, axis, Const.MOT_TRUE, timeout);
            Console.WriteLine($"Motion_enableBreakPoint in axis{axis}, status: {err}");
