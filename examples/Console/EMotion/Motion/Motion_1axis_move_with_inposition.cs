/// Motion_1axis_move_with_inposition.cs
///
...
class EMotion_1axis_move_with_inposition
{
    ...
    { 
        ...
        {   
            ...
            status = dev.Motion_cfgInposi(port, Constant.MOTION_AXIS_1, Constant.MOTION_ENABLE_FALSE, Constant.MOTION_POLARITY_ACTIVE_LOW);
            Console.WriteLine($"Motion_cfgInposi status: {status}");
