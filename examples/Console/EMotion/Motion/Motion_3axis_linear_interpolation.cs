...
class EMotion_3axis_linear_interpolation
{
    ...
    { 
        ...
        {   
            ...
            status = dev.Motion_cfg3AxisLinearInterpo(port, Constant.MOTION_AXIS_1, -2000, Constant.MOTION_AXIS_2, -2000, Constant.MOTION_AXIS_3, 3000, linear_interpo_vector_speed:2000);
            Console.WriteLine($"Motion_cfg3AxisLinearInterpo status: {status}");
            ...
            { 
                ...
                int axis3_move_status = dev.Motion_readMoveStatus(port, Constant.MOTION_AXIS_3);
