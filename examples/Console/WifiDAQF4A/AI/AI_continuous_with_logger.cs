...
/// Additionally, it utilizes a loop to retrieve AI data with 8 channels from WifiDAQF4A.
///
...
class WifiDAQF4A_DataLogger_AI_continuous
{
    static void loop_func(WifiDAQF4A handle, int port, int samples, int delay, int exit_time)
    {
