    ...
    static public void Main()
    {
        ...
        try
        {
            ...
            for (int i = 0; i < 30; i++)
            {
                if (i%2 == 0)
                {
                    status = dev.DO_writePins(port_DO, DO_pins, DO_even_state);
                }
                else
                {
                    status = dev.DO_writePins(port_DO, DO_pins, DO_odd_state);
                }
            ...
            // Close pin0, pin1, pin2 and pin3 in port 0 with digital input 
