...
{
    static void loop_func(EthanA handle, Datalogger handle2, int port, int num_of_samples, int delay = 50, int exit_loop_time = 300)
    {
        int time_cal = 0;
    ...
    static public void Main()
    {
        ...
        dev_logger.Logger_openFile("WPC_tester_EthanA_AI.csv");
