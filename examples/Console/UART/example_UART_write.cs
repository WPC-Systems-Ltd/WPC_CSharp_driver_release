...
///
/// This example demonstrates how to write data to another device with UART interface from WPC-USB-DAQ-F1-TD
/// 
...
class example_UART_write
{
    static public void Main()
    {
        ...
        try
        {
            ...
            // Set UART port to 2 and and write "WPC_systems" to device
