...
///
/// This example demonstrates how to get AI data and write to CSV file in continuous mode from STEM.
///
...
{
    static void loop_func(STEM handle, int port, int num_of_samples=600, int delay=50, int exit_loop_time=300)
    {
        int time_cal = 0;
