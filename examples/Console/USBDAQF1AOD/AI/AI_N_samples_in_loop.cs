/// AI_N_samples_in_loop.cs
/// 
/// This example demonstrates how to get AI data with loop in N samples mode from USBDAQF1AOD.
/// 
...
{
    static void loop_func(USBDAQF1AOD handle, int port, int num_of_samples, int delay = 1, int timeout = 3)
    {
        int t = 0;
        while (t < timeout)
        {
