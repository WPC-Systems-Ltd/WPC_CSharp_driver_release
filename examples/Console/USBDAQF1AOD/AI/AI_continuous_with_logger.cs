...
/// Additionally, it utilizes a loop to retrieve AI data with 8 channels from USBDAQF1AOD.
///
...
{
    static void loop_func(USBDAQF1AOD handle, int port, int samples, int delay, int exit_time)
    {
