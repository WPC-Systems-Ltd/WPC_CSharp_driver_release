...
///
/// This example demonstrates how to get AI data and write to CSV file in continuous mode from USBDAQF1AOD.
///
...
class USBDAQF1AOD_DataLogger_AI_continuous
{
    static void loop_func(USBDAQF1AOD handle, Datalogger handle2, int port, int num_of_samples, int delay = 50, int exit_loop_time = 300)
    {
        int time_cal = 0;
    ...
    static public void Main()
    {
        ...
        dev_logger.Logger_openFile("WPC_tester_USBDAQF1AOD_AI.csv");
