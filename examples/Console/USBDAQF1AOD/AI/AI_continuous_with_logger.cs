...
{
    static void loop_func(USBDAQF1AOD handle, int port, int num_of_samples=600, int delay=50, int exit_loop_time=300)
    {
        int time_cal = 0;
    ...
    static public void Main()
    {
        ...
        try
        {
            ...
            err = dev.Logger_openFile("WPC_tester_USBDAQF1AOD_AI.csv");
