    ...
    static public void Main()
    {
        ...
        try
        {
            ...
            */
            ...
            // Write WREN byte
            status = dev.SPI_write(SPI_port, new List<byte> { WREN });
            ...
            */
            ...
            status = dev.SPI_write(SPI_port, new List<byte> { WRITE, 0x00, 0x01, 0x0A });
            Console.WriteLine($"SPI_write status: {status}");
            ...
            */
            ...
            List<byte> data = dev.SPI_readAndWrite(SPI_port, new List<byte> { READ, 0x00, 0x01, DUMMY });
